...
//         id: index,
//         userName: log.pulls?.players?.users?.userName,
//         playerName: log.pulls?.players?.playerName,
//         userId:log.pulls?.players?.userId,
//         amount:log.pulls?.players?.amount,
//         cashoutMultiplier: log.pulls?.players?.cashoutMultiplier,
//         winAmount: log.pulls?.players?.winAmount,
//         isWinner: log.pulls?.players?.isWinner,
//         lossAmount: log.pulls?.players?.lossAmount
//     }));
//     return (
