...
function Index() {
  ...
  return (
    ...
    <div className="bg-[#1a2c38] flex flex-col">
      ...
      <div className="flex xl:gap-6 pt-14 pr-20 items-center -mt-2 md:w-52 xl:w-full w-32">
      ...
      <div className="flex xl:gap-1 pt-14 pt-5.5 pr-20 items-center w-full -mt-1">
        ...
        <div className="w-1/2 xl:w-[30rem] max-w-screen-md xl:h-[340px] me-px m-auto mt-[-1rem] p-[10px] ml-auto">
